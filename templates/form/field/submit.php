...
?><input type="submit" value="<?php echo esc_attr( apply_filters( "wordpresscrm_form_submit_button", __( 'Submit', 'integration-dynamics' ), $form ) ); ?>" class="btn btn-default" name="entity_form_submit"></div><?php
